...
@str1 = private constant [11 x i8] [i8 73, i8 78, i8 84, i8 32, i8 35, i8 37, i8 48, i8 50, i8 88, i8 10, i8 0]
...
then_6:
    ; U-type
    %39 = call i32(i32) @extract_imm31_12 (i32 %14)
...
then_8:
    %60 = call i32(i32) @extract_imm12 (i32 %14)
    ;printf("jalr %d(x%d)\n", imm, rs1)
    ; rd <- pc + 4
    ; pc <- (rs1 + imm) & ~1
...
then_10:
    %77 = call i8(i32) @extract_funct7 (i32 %14)
    %78 = call i8(i32) @extract_rd (i32 %14)
    %79 = and i8 %78, 30
...
then_24:
    %201 = call i32(i32) @extract_imm12 (i32 %14)
...
then_25:
    ; lb
    ;printf("lb x%d, %d(x%d)\n", rd, imm, rs1)
    %208 = getelementptr inbounds %Core, %Core* %core, i32 0, i32 5
    ...
    %214 = icmp ne i8 %16, 0
    br i1 %214 , label %then_26, label %endif_26
then_26:
...
else_25:
    %217 = icmp eq i8 %19, 1
    br i1 %217 , label %then_27, label %else_27
then_27:
    ; lh
    ;printf("lh x%d, %d(x%d)\n", rd, imm, rs1)
    %218 = getelementptr inbounds %Core, %Core* %core, i32 0, i32 5
    ...
    %224 = icmp ne i8 %16, 0
    br i1 %224 , label %then_28, label %endif_28
then_28:
...
else_27:
    %227 = icmp eq i8 %19, 2
    br i1 %227 , label %then_29, label %else_29
then_29:
    ; lw
    ;printf("lw x%d, %d(x%d)\n", rd, imm, rs1)
    %228 = getelementptr inbounds %Core, %Core* %core, i32 0, i32 5
    ...
    ;printf("LW [0x%x] (0x%x)\n", adr, val)
    %234 = icmp ne i8 %16, 0
    br i1 %234 , label %then_30, label %endif_30
then_30:
...
else_29:
    %237 = icmp eq i8 %19, 4
    br i1 %237 , label %then_31, label %else_31
then_31:
    ; lbu
    ;printf("lbu x%d, %d(x%d)\n", rd, imm, rs1)
    %238 = getelementptr inbounds %Core, %Core* %core, i32 0, i32 5
    ...
    %245 = icmp ne i8 %16, 0
    br i1 %245 , label %then_32, label %endif_32
then_32:
...
else_31:
    %248 = icmp eq i8 %19, 5
    br i1 %248 , label %then_33, label %endif_33
then_33:
    ; lhu
    ;printf("lhu x%d, %d(x%d)\n", rd, imm, rs1)
    %249 = getelementptr inbounds %Core, %Core* %core, i32 0, i32 5
...
else_24:
    ...
    br i1 %259 , label %then_35, label %else_35
then_35:
    %260 = call i8(i32) @extract_funct7 (i32 %14)
...
endif_36:
    br label %endif_35
else_35:
    %293 = icmp eq i32 %14, 115
    br i1 %293 , label %then_39, label %else_39
then_39:
    ;printf("ECALL\n")
    br label %endif_39
else_39:
    %294 = icmp eq i32 %14, 1048691
    br i1 %294 , label %then_40, label %else_40
then_40:
    ;printf("EBREAK\n")
    ret i1 0
    br label %endif_40
else_40:
    %296 = icmp eq i32 %14, 16777231
    br i1 %296 , label %then_41, label %else_41
then_41:
    ;printf("PAUSE\n")
    br label %endif_41
else_41:
...
endif_3:
    br label %endif_2
endif_2:
    %297 = getelementptr inbounds %Core, %Core* %core, i32 0, i32 3
    %298 = load i1, i1* %297
    br i1 %298 , label %then_42, label %else_42
then_42:
    %299 = getelementptr inbounds %Core, %Core* %core, i32 0, i32 1
    %300 = load i32, i32* %299
    %301 = add i32 %300, 4
    %302 = getelementptr inbounds %Core, %Core* %core, i32 0, i32 1
